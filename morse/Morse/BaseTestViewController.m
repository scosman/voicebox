...
-(NSArray<TestClassDefinition *> *)buildKeyboardInView:(UIView *)keyboardContainer {
    NSAssert(false, @"you must override this class");
    return nil;
}
...
-(void) copyResults:(id)sender {
    NSDictionary* jsonStructure = @{
        ...
        @"orientation": self.view.frame.size.width > self.view.frame.size.height ? @"landscape" : @"portrait",
